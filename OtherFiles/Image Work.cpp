// TODO  1 Надо сделать разные фоны по которым будет ехать скейтер.
// TODO  2 Сделать препятствие скейтеру, при столкнавении с которым он бы терял очки или проигрывал.
// TODO  3 Сдеать так, что если скейтер доезжает до конца экрана, то сменяется фон и скейтер телепортируется на начало экрана.
#include  "TXlib.h"
